...
def execute_ndf_bladerow(ndf_file,
                         bladerow,
                         blade,
                         settings,
                         progress_updates_queue,
...
def execute_tginit_bladerow(tginit_file,
                            blade_row,
                            blade,
                            settings,
                            progress_updates_queue,
...
def execute_ndf_blade_row_ansys_labs(ndf_file,
                                     bladerow,
                                     blade, 
                                     settings,
                                     progress_updates_queue,
...
def execute_tginit_blade_row_ansys_labs(tginit_file,
    ...
    try:         
        ...
        progress_updates_queue.put([blade_row+"/"+blade,f"IP:{pytg_instance.ftp_ip} port:{pytg_instance.ftp_port}"])
