...
Module in the ansys-turbogrid-api package that is internally used by modules in pyturbogrid repository package for interactions with a running Ansys TurboGrid application.
Some of the methods from the classes in this module may be utilized by a user interacting with the pyturbogrid repository package.
...
.. py:class:: PyTurboGrid
    ...
    The TurboGrid session, and any peripherals of it, will be collectively called the 'server'.
