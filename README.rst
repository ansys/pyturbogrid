...
In order to install PyTurboGrid, make sure you
...
.. code:: bash
    ...
    python -m pip install ansys-turbogrid

For developers
^^^^^^^^^^^^^^

Installing PyTurboGrid in developer mode allows
...
#. Start by cloning this repository:
   ...
   .. code:: bash
      ...
      git clone https://github.com/pyansys/pyturbogrid
...
#. Install the project in editable mode:
    ...
    .. code:: bash
      ...
      python -m pip install --editable ansys-turbogrid
